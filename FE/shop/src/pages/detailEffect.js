...
export default function OutsideAlerter(props) {
  ...
  return (
    <div
      ...
      style={{ width: '75%' }}
    >
      <Detail scl={props.scl} search={props.search} updateCd={props.updateCd} setCd={props.setCd} cd={props.cd} id={props.id} setRecentList={props.setRecentList} recentList={props.recentList}/>
    </div>
  );
}